      ...
      return el("div", { style: st.root },
        ...
        loading
          ...
          : el("div", null,
            ...
            tab === "prices" ? el(PriceView, { pricing: data.pricing, effectiveAt: data.effectiveAt, effectiveV41At: data.effectiveV41At, fx: data.fx || {}, budget: data.budget, onBudgetChange: saveBudget, onFxRefresh: function () { api({ action: "fxRefresh" }).then(refresh).catch(function () {}); }, onChanged: refresh }) : null
          ),
        el("div", { style: st.actions, marginTop: 8 },
