window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var setLang = function (lang) {
      ...
      __LANG = next;
      try { window.localStorage.setItem("dsh-usage-lang", __LANG); } catch (e) {}
    ...
    function BalancePanel() {
      ...
      var heroLabel = d && d.balanceLabelKey ? tb(d.balanceLabelKey) : ((d && d.providerName) || selected.name) + t(" · 账户余额");
      ...
      return el("div", { style: st.root },
        ...
        provider === "siliconflow"
          ...
          : null,
        d && d.ok ? el("div", { style: st.note }, (d.sourceNoteKey ? tb(d.sourceNoteKey) : "") + (credentialMeta.length ? " " + credentialMeta.join(__LANG === "en" ? "; " : "；") + (__LANG === "en" ? "." : "。") : "")) : null,
