window.__ModuleLoader__.load({
  id: "@wuhuqif176/dsh-usage-plugin",
  factory: (require) => {
    var module = { exports: {} };
      ...
      return el("div", { style: st.root },
        ...
        d && d.ok && isQwen
          ? el("div", { style: st.qwenWeekCard },
              el("div", { style: st.qwenWeekLabel }, "本周配额"),
              el("div", { style: st.qwenWeekRow },
                el("div", { style: st.qwenWeekItem },
                  el("span", { style: st.qwenWeekHint }, "开始"),
                ...
                el("div", { style: st.qwenWeekItemR },
                  el("span", { style: st.qwenWeekHint }, "结束"),
